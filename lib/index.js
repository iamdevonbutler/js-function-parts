...
self.reconstruct = (obj) => {
  ...
  var {isAsync = false, isGenerator = false, isArrowFunc = false, name = '', params = '', body} = obj;
  params = params || '';
  body = body || '';
  ...
  while (1) {
    ...
    // Parse body...
      ...
      return {
        isGenerator,
        isAsync,
        isArrowFunc: !functionKeyword,
        name: func.name || null, // @note anonmyous funcs, once func.toStringED, can have a name of 'anonmyous'.
        params: params || null,
        body: body || null,
      };
    }
